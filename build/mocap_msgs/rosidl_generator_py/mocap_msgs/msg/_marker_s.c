...
bool mocap_msgs__msg__marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap_msgs.msg._marker.Marker", full_classname_dest, 29) == 0);
  }
  mocap_msgs__msg__Marker * ros_message = _ros_message;
  {  // id_type
...
PyObject * mocap_msgs__msg__marker__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap_msgs.msg._marker");
