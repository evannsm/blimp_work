...
bool mocap_msgs__msg__imus_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap_msgs.msg._imus_info.ImusInfo", full_classname_dest, 34) == 0);
  }
  mocap_msgs__msg__ImusInfo * ros_message = _ros_message;
  {  // sensor_ids
...
PyObject * mocap_msgs__msg__imus_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap_msgs.msg._imus_info");
