...
static const _RigidBodies_type_support_symbol_names_t _RigidBodies_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mocap_msgs, msg, RigidBodies)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mocap_msgs, msg, RigidBodies)),
  }
};
...
{
  return &::mocap_msgs::msg::rosidl_typesupport_cpp::RigidBodies_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mocap_msgs, msg, RigidBodies)() {
  return get_message_type_support_handle<mocap_msgs::msg::RigidBodies>();
}
