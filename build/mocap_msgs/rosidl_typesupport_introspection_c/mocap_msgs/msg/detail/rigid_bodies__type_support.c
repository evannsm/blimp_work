...
#include <stddef.h>
#include "mocap_msgs/msg/detail/rigid_bodies__rosidl_typesupport_introspection_c.h"
...
// Member `rigidbodies`
#include "mocap_msgs/msg/rigid_body.h"
// Member `rigidbodies`
  ...
  const void * untyped_member)
{
  const mocap_msgs__msg__RigidBody__Sequence * member =
    (const mocap_msgs__msg__RigidBody__Sequence *)(untyped_member);
  return member->size;
}
  ...
  void * untyped_member, size_t index)
{
  mocap_msgs__msg__RigidBody__Sequence * member =
    (mocap_msgs__msg__RigidBody__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  mocap_msgs__msg__RigidBody__Sequence * member =
    (mocap_msgs__msg__RigidBody__Sequence *)(untyped_member);
  mocap_msgs__msg__RigidBody__Sequence__fini(member);
...
static rosidl_typesupport_introspection_c__MessageMember mocap_msgs__msg__RigidBodies__rosidl_typesupport_introspection_c__RigidBodies_message_member_array[3] = {
  {
    ...
    offsetof(mocap_msgs__msg__RigidBodies, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mocap_msgs__msg__RigidBodies, frame_number),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
