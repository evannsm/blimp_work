...
#include "mocap_msgs/msg/detail/markers__rosidl_typesupport_fastrtps_c.h"
...
using _Markers__ros_msg_type = mocap_msgs__msg__Markers;
...
size_t get_serialized_size_mocap_msgs__msg__Markers(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Markers__ros_msg_type * ros_message = static_cast<const _Markers__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Markers__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mocap_msgs__msg__Markers(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mocap_msgs
size_t max_serialized_size_mocap_msgs__msg__Markers(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mocap_msgs__msg__Markers;
    is_plain =
      (
...
static size_t _Markers__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mocap_msgs__msg__Markers(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap_msgs, msg, Markers)() {
